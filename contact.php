...
<head>
  <meta charset="utf-8" />
  <title>Marcel Gaudard Cheik Kaled</title>

  <!-- Meta Data -->
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

  <meta name="author" content="Marcel Gaudard Cheik Kaled" />
  <meta name="description" content="Portifólio de trabalhos realizados e formação de Marcel Gaudard Cheik Kaled" />
  <!-- Styles -->
    ...
    <div class="container gutter-top">
      ...
      <header class="header box">
        <div class="header__left">
          <div class="header__photo">
            <img class="header__photo-img" src="assets/img/profile.jpeg" alt="Marcel Gaudard Cheik Kaled">
          </div>
          <div class="header__base-info">
            <h4 class="title titl--h4">Marcel Gaudard Cheik Kaled</h4>
            <div class="status">Programador e Desenvolvedor</div>
            <ul class="header__social">
              <li>
                <a href="https://www.linkedin.com/in/marcel-gaudard-cheik-kaled/">
              ...
              <li>
                <a href="https://www.instagram.com/codificando.data/">
        ...
        <div class="header__right">
          <ul class="header__contact">
            <li>
              ...
              mgck.comercial@contato.com.br
            </li>
            <li>
              <span class="overhead">Telefone</span><a href="https://api.whatsapp.com/send?phone=55xxxxxxxxxxx">+55 (xx)
                xxxxx-xxxx </a>
            </li>
          </ul>
          <ul class="header__contact">
      ...
      <div class="row sticky-parent">
        ...
        <div class="col-12 col-md-12 col-lg-10">
            ...
            <form action="email.php" method="post" id="contact-form" class="contact-form" data-toggle="validator">
              <div class="row">
                <div class="form-group col-12 col-md-6">
                  <input type="text" class="form-control" id="nameContact" name="nameContact" placeholder="Nome"
                    required="required" autocomplete="on" oninvalid="setCustomValidity('Fill in the field')"
                    onkeyup="setCustomValidity('')">
                  <div class="help-block with-errors"></div>
                </div>
                <div class="form-group col-12 col-md-6">
                  <input type="phone" class="form-control" id="phoneContact" name="phoneContact" placeholder="Telefone"
                ...
                <div class="form-group col-12 col-md-12">
                  <textarea class="textarea form-control" id="messageContact" name="messageContact"
                    ...
                    oninvalid="setCustomValidity('Fill in the field')" onkeyup="setCustomValidity('')"></textarea>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="row">
          ...
          <!-- Footer -->
          <footer class="footer">© Marcel Gaudard Cheik Kaled</footer>
        </div>
      </div>
    </div>
  </main>
